...
mutation heart($age: Int!, $sex: Int!, $cp: Int!, $trestbps: Int!, $chol: Int!, $fbs: Int!, $restecg: Int!, $thalach: Int!, $exang: Int!, $oldpeak: Float!, $slope: Int!, $ca: Int!, $thal: Int!) {
  heartDiseasePredict(age: $age, sex: $sex, cp: $cp, trestbps: $trestbps, chol: $chol, fbs: $fbs, restecg: $restecg, thalach: $thalach, exang: $exang, oldpeak: $oldpeak, slope: $slope, ca: $ca, thal: $thal) {
    message
  }
}
`;
